...
class TestDistanceCliSqlitePrefix(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if not os.path.exists(sample_large):
            systems = [
                {"id64": 1, "name": "Sol-Alpha", "coords": {"x": 0, "y": 0, "z": 0}, "needsPermit": False, "mainStar": "G"},
                {"id64": 2, "name": "Sol-Beta",  "coords": {"x": 30, "y": 0, "z": 0}, "needsPermit": False, "mainStar": "K"},
                {"id64": 3, "name": "FarAway",   "coords": {"x": 1000, "y": 0, "z": 0}, "needsPermit": True,  "mainStar": "M"},
                {"id64": 4, "name": "Sol-Gamma", "coords": {"x": 60, "y": 0, "z": 0}, "needsPermit": False, "mainStar": "G"}
            ]
